...
function statChangeHandler(event) {
  ...
  if (str > max) {
	alert("Strength must be less than 20");
	statInvalid = true;
  }
  if (dex > max) {
	alert("Dexterity must be less than 20");
	statInvalid = true;
  }
  if (con > max) {
	alert("Constitution must be less than 20");
	statInvalid = true;
  }
  if (wis > max) {
	alert("Wisdom must be less than 20");
	statInvalid = true;
  }
  if (inT > max) {
	alert("Intelligence must be less than 20");
	statInvalid = true;
  }
  if (cha > max) {
	alert("Charisma must be less than 20");
	statInvalid = true;
